...
function esercizio1(somma, valore) {
  return somma(valore);
}
...
function numeri(a, callback) {
  return a.map((x) => callback(x));
}
...
function number (numeri, ritorno){
...
// function esercizo (oggetti, callback, categoria){
//   const result = {}
